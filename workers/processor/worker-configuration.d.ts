/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 563f663e685e4415a76d59145969d818)
// Runtime types generated with workerd@1.20260409.1 2026-04-06 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/queue");
		durableNamespaces: "TranscriberContainer" | "LargeTranscriberContainer";
	}
	interface Env {
		...
		TRANSCRIBER: DurableObjectNamespace<import("./src/queue").TranscriberContainer>;
		TRANSCRIBER_LARGE: DurableObjectNamespace<import("./src/queue").LargeTranscriberContainer>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PROCESSING_VERSION" | "CLASSIFICATION_PROVIDER" | "POSTHOG_HOST" | "POSTHOG_PROJECT_API_KEY" | "TRANSCRIPTION_GATEWAY_TOKEN">> {}
}
declare module "*.mp3" {
